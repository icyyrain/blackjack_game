...
The build script converts the SVG card artwork in `assets\poker-super2-box-top-qr` to PNG files in `assets\cards`, then writes the executable to `dist\Blackjack.exe`.
